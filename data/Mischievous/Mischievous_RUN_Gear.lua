function user_job_setup()
	...
	autows_list = {
		...
		["Hepatizon"] = "Full Break",
		autowstp = 1250
	}

	gear.tank_back = { name = "Ogma's Cape", augments = { "HP+60", "Eva.+20 /Mag. Eva.+20", "Enmity+10", "Phys. dmg. taken-10%" }, }
	...
	gear.jse_da_back = { name = "Ogma's cape", augments = { "DEX+20", "Accuracy+20 Attack+20", '"Dbl.Atk."+10', "Phys. dmg. taken-10%" }, }
...
function init_gear_sets()
	...
	sets.precast.JA['Vallation'] = set_combine(sets.Enmity,
		{ body = { name = "Runeist Coat +3", priority = 218 }, legs = { name = "Futhark Trousers +3", priority = 107 }, })
	...
	sets.precast.JA['Vivacious Pulse'] = {
		head = { name = gear.jse_empy_head, priority = 91 },
		neck =
		"Incanter's Torque",
	...
	sets.precast.FC.ValianceVallation = set_combine(sets.precast.FC,
		{ neck = { name = "Unmoving Collar +1", priority = 500 } })
	sets.precast.FC.ValianceVallationEnhancing = set_combine(sets.precast.FC,
		{ legs = "Futhark Trousers +3", neck = { name = "Unmoving Collar +1", priority = 500 } })
	...
	sets.midcast['Regen'] = set_combine(sets.midcast['Enhancing Magic'],
		{ head = "Runeist Bandeau +3", neck = "Sacro Gorget", waist = "Sroda Belt", right_ear = gear.empy_earring })
	sets.midcast['Regen'].SIRD = set_combine(sets.midcast['Enhancing Magic'],
		{ head = "Runeist Bandeau +3", neck = "Sacro Gorget", waist = "Sroda Belt", right_ear = gear.empy_earring })
	sets.midcast['Regen'].DT = set_combine(sets.midcast['Enhancing Magic'],
		{ head = "Runeist Bandeau +3", neck = "Sacro Gorget", waist = "Sroda Belt", right_ear = gear.empy_earring })
