function user_job_setup()
    ...
    state.Weapons:options("TizThib", "TizZan", "NaegThib", "NaegZan", "Maxentius", "Magic", "MACC", "Learn", "None")
...
function init_gear_sets()
    ...
    sets.precast.FC = {
        ...
        body = "Pinga Tunic", -- 13
        hands = "Pinga Mittens", -- 5 Leyline Glove upgrade --8
        legs = "Pinga Pants", -- 13
    ...
    sets.midcast["Blue Magic"].Magical = {
        ...
        legs = "Amalric Slops +1", -- Luhlaza Shalwar +3 Upgrade
    ...
    sets.midcast['Blue Magic'].MagicAccuracy = {
        ...
        right_ring = "Stikini Ring +1", -- 6% FC
        back = gear.jse_macc_fc_back, -- 10% FC
    }
