...
function init_gear_sets()
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC,
        { ammo = "Sapience Orb", left_ring = "Kishar Ring", right_ring = "Crepuscular Ring" })
    ...
    sets.ResistantMagicBurst = set_combine(sets.MagicBurst,
        { main = "Marin Staff +1", sub = "Khonsu", hands = "Spae. Gloves +3", })
    ...
    sets.midcast.Aquaveil = set_combine(sets.midcast['Enhancing Magic'],
        { main = "Vadose Rod", sub = "Genmei Shield", head = "Amalric Coif +1", hands = "Regal Cuffs" })
    ...
    sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Elemental Magic'],
        { hands = "Spae. Gloves +3", legs = "Agwu's Slops", feet = "Arch. Sabots +3" })
