function user_job_setup()
    ...
    state.Weapons:options('None', 'DualMurCea', 'DualMurgleis', 'DualCrocea', 'DualCroDay', 'DualSequence', 'DualSavage',
        'DualEvis', 'DualClubs', 'Murgleis', 'Crocea', 'Sequence', 'Naegling', 'Maxentius')
...
function init_gear_sets()
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC,
        { ammo = "Sapience Orb", left_ring = "Petrov Ring", back = gear.jse_mab_back })
    ...
    sets.precast.WS['Sanguine Blade'] = set_combine(sets.precast.WS['Seraph Blade'],
        { head = "Pixie Hairpin +1", left_ring = "Archon Ring", back = gear.jse_mab_back })
    ...
    sets.midcast.Cursna = set_combine(sets.midcast.Cure,
        { neck = "Debilis Medallion", left_ring = "Haoma's Ring", right_ring = "Menelaus's Ring" })
    ...
    sets.midcast.Refresh = { head = "Amalric Coif +1", body = "Atrophy Tabard +3", hands = "Atrophy Gloves +3", legs =
    gear.jse_empy_legs }
    ...
    sets.midcast['Bio III'] = set_combine(sets.midcast['Enfeebling Magic'],
        { head = "Viti. Chapeau +3", waist = "Chaac Belt", feet = gear.chironic_treasure_feet })

    sets.midcast.Impact = set_combine(sets.midcast['Enfeebling Magic'].Resistant, { head = empty, body = gear
    .impact_body })
