...
function init_gear_sets()
    -- Weapons sets
    sets.weapons.Epeolatry = { main = "Aettir", sub = "Utu Grip" }
    ...
    sets.precast.JA["Battuta"] = set_combine(sets.Enmity, { head = { name = "Futhark Bandeau +3", priority = 56 }, legs = { name = "Erilaz Leg Guards +1", priority = 80 }, feet = { name = "Terms Leggings +1", priority = 76 }, back = gear.tank_back, })
    ...
    sets.engaged.Tank = {
        ...
        feet = { name = "Terms Leggings +1", priority = 76 }, --
        neck = { name = "Futhark Torque +2", priority = 60 }, -- 			/ 6 DT	/
        waist = "Flume Belt +1", -- 4 PDT 	/		/
        left_ear = { name = "Etiolation Earring", priority = 50 },
