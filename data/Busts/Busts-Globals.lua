...
send_command('bind !f input //mc fon') --CTRL F
send_command('bind ^f input //mc foff') --ALT F
send_command('bind ^. sat allcommand silence') --ctrl .
send_command('bind @n send @all gs c toggle autoshadowmode') --Shadows for dayz. Windows N
send_command('bind !c send Healtaru curaga4 Mischievous') --Alt C
send_command('bind !x send Healtaru cure5 Mischievous') --Alt X
send_command('bind !d input //mc fin') --Alt D
...
send_command('bind !d sat allcommand  Dia II') --Alt DD
